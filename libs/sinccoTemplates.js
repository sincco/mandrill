(function ($) {
    ...
    // Get template defined in an element
	$.fn.getTemplate = function () {
        return $(this).data('template');
    }

    $.fn.setTemplate = function (template) {
        $(this).data('template', template);
    }
    
    // PRINCIPAL FUNCTION TO PROCESS A TEMPLATE
    $.fn.processTemplate = function (data, options) {
        $(this).loadTemplate( $(this).getTemplate() + '.html', data, options );
    }
